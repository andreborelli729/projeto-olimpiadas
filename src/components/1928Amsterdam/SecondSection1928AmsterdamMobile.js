...
function SecondSection1928AmsterdamMobile(){
    ...
    return  (
        ...
        <h4 className="resultsTitle">Resultado Geral de Países em 1928(Amsterdam - Países Baixos)</h4>
          <table className="table-results">
            ...
            <td className="columnType1"><img src={alemanha} alt="bandeira da Alemanha" className="flagImg"></img><p className="sportLabel">Alemanha</p></td>
              ...
              <td className="columnType3 columnType3Padding"><p className="sportLabel">31</p></td>
            </tr>
          ...
          <h5 className="list-title">Medalistas brasileiros na edição de 1928 (Amsterdam - Países Baixos):</h5>
          <p className="list-item2">Os atletas brasileiros não participaram dessa edição, vindo a participar de todas as edições seguintes.
</p>
<Link to='/edicoes'>
...
export default SecondSection1928AmsterdamMobile;