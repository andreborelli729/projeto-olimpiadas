...
function ForthSectionVoleiMobile() {
    return (
...
<tr>
  ...
  <td className="columnParis"><p className="paris-item">Seleção Brasileira feminina de Vôlei.</p></td>
</tr>
...
export default ForthSectionVoleiMobile;