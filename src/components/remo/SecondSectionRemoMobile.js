...
import irlanda from '../../flags/irlanda.png';
...
function SecondSectionRemoMobile(){
    ...
    return  (
        ...
        <h4 className="resultsTitle">Melhores Países em 2024(Paris - França)</h4>
          <table className="table-results">
            ...
            <tr className="rowType1">
              <td className="columnType1"><img src={irlanda} alt="bandeira da Irlanda" className="flagImg"></img><p className="sportLabel">Irlanda</p></td>
...
export default  SecondSectionRemoMobile;