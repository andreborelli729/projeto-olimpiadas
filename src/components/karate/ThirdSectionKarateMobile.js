...
function ThirdSectionKarateMobile() {
    return(

<section className="thirdSection">
<div className="thirdSectionColumn1">
<ul>
<h4 className="list-title">Modalidades de Karatê</h4>
<p className="list-title">Masculino/Feminino:</p>
<li className="list-item">Kata;
</li>
<li className="list-item">Kumite.
</li>
...
export default ThirdSectionKarateMobile;