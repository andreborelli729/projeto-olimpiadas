...
function ThirdSectionPoloAquaticoMobile() {
    return(

<section className="thirdSection">
<div className="thirdSectionColumn1">
<ul>
<h4 className="list-title">Modalidades do Polo Aquatico</h4>
<p className="list-title">Masculino/Feminino:</p>
<li className="list-item">Jogo em equipe;
</li>
...
export default ThirdSectionPoloAquaticoMobile;