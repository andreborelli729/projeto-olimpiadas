...
function ThirdSection1948LondresMobile() {
    return (

<section className="parisResults">
  <div className="parisFirst">
<h4 className="item-title">Melhores atletas brasileiros na edição de 1948 (Londres - Grã-Bretanha):</h4>
...
<p className="sportParagraph">Total: 0 ouro(s), 0 prata(s), 1 bronze(s), 1 medalha(s) ao todo, sendo o 34º país no resultado geral desta edição.</p>
...
export default ThirdSection1948LondresMobile;