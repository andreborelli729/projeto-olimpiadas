...
function FifthSectionPentatloModernoMobile () {
    return (
...
<section className="geralResults">
  ...
  <tr>
    ...
    <td className="columnParis"><p className="paris-item">Yane Marques.
    </p></td>
  </tr>
...
export default FifthSectionPentatloModernoMobile;