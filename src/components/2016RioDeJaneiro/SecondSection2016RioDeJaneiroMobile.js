...
function SecondSection2016RioDeJaneiroMobile(){
    ...
    return  (
        ...
        <h4 className="resultsTitle">Resultado Geral de Países em 2016(Rio de Janeiro - Brasil)</h4>
          <table className="table-results">
            ...
            <td className="columnType2"><p className="sportLabel">1º</p></td>
              ...
              <td className="columnType3 columnType3Padding"><p className="sportLabel">121</p></td>
            </tr>
            <tr className="rowType1">
            <td className="columnType1"><img src={graBretanha} alt="bandeira da Grã-Bretanha" className="flagImg"></img><p className="sportLabel">Grã-Bretanha</p></td>
              ...
              <td className="columnType3 columnType3Padding"><p className="sportLabel">67</p></td>
            </tr>
            ...
            <td className="columnType2"><p className="sportLabel">3º</p></td>
              ...
              <td className="columnType2"><p className="sportLabel">26</p></td>
              <td className="columnType3 columnType3Padding"><p className="sportLabel">70</p></td>
            </tr>
...
export default SecondSection2016RioDeJaneiroMobile;