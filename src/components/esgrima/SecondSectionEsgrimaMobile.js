    ...
    return  (
        ...
        <h4 className="resultsTitle">Melhores Países em 2024(Paris - França)</h4>
          <table className="table-results">
            ...
            <tr className="rowType1">
              <td className="columnType1"><img src={republicaDaCoreia} alt="bandeira da República da Coréia" className="flagImg"></img><p className="sportLabel">República da Coréia</p></td>
            ...
            <tr className="rowType1">
              <td className="columnType1"><img src={hongKong} alt="bandeira de Hong-Kong - China" className="flagImg"></img><p className="sportLabel">Hong-Kong (CHINA)</p></td>
