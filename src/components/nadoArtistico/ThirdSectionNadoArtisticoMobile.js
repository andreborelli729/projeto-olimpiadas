...
function ThirdSectionNadoArtisticoMobile() {
    return(

<section className="thirdSection">
<div className="thirdSectionColumn1">
<ul>
<h4 className="list-title">Modalidades do Nado Artístico</h4>
<p className="list-title">Masculino/Feminino:</p>
<li className="list-item">Dueto;
</li>
<li className="list-item">Competição por Equipes.
</li>
...
<p className="list-item2">A equipe feminina não se classificou para essa modalidade
</p>

<h5 className="list-title">Melhores atletas brasileiros no esporte na edição de 2024 (Paris - França):</h5>
<p className="list-item2">Os atletas brasileiros não se classificaram para essa modalidade nessa edição.
...
export default ThirdSectionNadoArtisticoMobile;