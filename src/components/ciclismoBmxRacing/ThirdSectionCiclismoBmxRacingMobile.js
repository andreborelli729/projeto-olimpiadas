...
<ul>
<h4 className="list-title">Modalidades do Ciclismo BMX Racing</h4>
<p className="list-title">Masculino/Feminino:</p>
<li className="list-item">	BMX Racing. </li>
...
<p className="list-item2">Não temos atletas masculinos nessa modalidade das olímpiadas. </p>

<h5 className="list-title">Feminino:</h5>
<p className="list-item2">Paôla Reis.
</p>

<h5 className="list-title">Melhores atletas brasileiros no esporte na edição de 2024 (Paris - França):</h5>
<p className="list-item2">Paôla Reis terminou as olímpiadas ocupando a 15ª posição na categoria nessas olímpiadas.
</p>
