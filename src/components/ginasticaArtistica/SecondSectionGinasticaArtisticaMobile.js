...
import filipinas from '../../flags/filipinas.avif';
        ...
        <h4 className="resultsTitle">Melhores Países em 2024(Paris - França)</h4>
          <table className="table-results">
            ...
            <tr className="rowType1">
              ...
              <td className="columnType3 columnType3Padding"><p className="sportLabel">9</p></td>
            </tr>
            <tr className="rowType1">
            ...
            <tr className="rowType1">
              <td className="columnType1"><img src={filipinas} alt="bandeira das Filipinas" className="flagImg"></img><p className="sportLabel">Filipinas</p></td>
